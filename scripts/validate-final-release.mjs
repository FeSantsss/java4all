...
const requiredDocs = [
  ...
  [readme, '160 exercícios'],
  [readme, '268 verificações'],
  [readme, '384 conceitos'],
  [readme, 'phase-20-final-release-hardening.md'],
  [readme, 'phase-21-deployment-readiness.md'],
  [readme, 'phase-22-maintenance-guardrails.md'],
  [readme, 'phase-23-progress-contract.md'],
  [readme, 'phase-24-ui-accessibility-contract.md'],
  [readme, 'phase-25-learning-tools-contract.md'],
  [readme, 'phase-26-catalog-integrity.md'],
  [readme, 'phase-27-assessment-integrity.md'],
  [readme, 'phase-28-resource-integrity.md'],
  [readme, 'phase-29-technical-english-contract.md'],
  [readme, 'phase-30-traceability-contract.md'],
  [readme, 'phase-31-master-spec-closure.md'],
  [readme, 'npm run validate:ui'],
  [readme, 'npm run validate:learning-tools'],
  [readme, 'npm run validate:catalog'],
  [readme, 'npm run validate:assessment'],
  [readme, 'npm run validate:resources'],
  [readme, 'npm run validate:technical-english'],
  [readme, 'npm run validate:traceability'],
  [readme, 'npm run validate:master-spec'],
  [readme, 'npm run validate:deployment'],
  [readme, 'npm run validate:maintenance'],
  [readme, 'npm run validate:progress'],
